...
StoneShape.objects.get_or_create(shape='Round')
StoneShape.objects.get_or_create(shape='Princess')
StoneShape.objects.get_or_create(shape='Cushion')
StoneShape.objects.get_or_create(shape='Oval')
StoneShape.objects.get_or_create(shape='Emerald')
StoneShape.objects.get_or_create(shape='Pear')
StoneShape.objects.get_or_create(shape='Asscher')
StoneShape.objects.get_or_create(shape='Radiant')
StoneShape.objects.get_or_create(shape='Marquise')
StoneShape.objects.get_or_create(shape='Other')

StoneType.objects.get_or_create(type='Sapphire')
StoneType.objects.get_or_create(type='Ruby')
StoneType.objects.get_or_create(type='Emerald')
StoneType.objects.get_or_create(type='Diamond')

Gender.objects.get_or_create(type='male')
Gender.objects.get_or_create(type='female')
Gender.objects.get_or_create(type='uni')

MetalColor.objects.get_or_create(color='White Gold')
MetalColor.objects.get_or_create(color='Yellow Gold')
MetalColor.objects.get_or_create(color='Rose Gold')
MetalColor.objects.get_or_create(color='Silver')

MetalType.objects.get_or_create(type='14k')
MetalType.objects.get_or_create(type='18k')

JewelryShape.objects.get_or_create(shape='Ring')
JewelryShape.objects.get_or_create(shape='Necklace')
JewelryShape.objects.get_or_create(shape='Earrings')
JewelryShape.objects.get_or_create(shape='Bracelet')
